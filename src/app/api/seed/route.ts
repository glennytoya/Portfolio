...
export async function GET(req: NextRequest) {
  ...
  if (!existing) {
    ...
    await Admin.create({ email: adminEmail, password: hashed, name: 'Glenn Toya' })
  }
    ...
    await Project.insertMany([
      {
        ...
        githubUrl: 'https://github.com/glennytoya/nexus',
        featured: true,
        order: 1,
        status: 'published',
      },
      {
        ...
        githubUrl: 'https://github.com/glennytoya/forma',
        featured: true,
        order: 2,
        status: 'published',
      },
      {
        ...
        liveUrl: 'https://ledger.glennytoya.dev',
        featured: true,
        order: 3,
        status: 'published',
      },
      {
        ...
        githubUrl: 'https://github.com/glennytoya/pulsar',
        featured: false,
        order: 4,
        status: 'published',
      },
