    ...
    <section className="relative min-h-screen flex items-center overflow-hidden pt-16">
      ...
      <div className="section-container relative z-10 py-24">
        <div className="max-w-3xl">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-violet-100 dark:bg-violet-900/30 border border-violet-200 dark:border-violet-800 mb-6">
